"""
Django settings for rcraceready project.
...
SECRET_KEY = 'django-insecure-5tm+l9e0_oz%lu7=k@#hh#9nz=9n9w2%ia(^-)yjl)=gw!z^jj'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['rcraceready.herokuapp.com', 'localhost']
...
DEFAULT_FROM_EMAIL = 'rcraceready@example.com'
